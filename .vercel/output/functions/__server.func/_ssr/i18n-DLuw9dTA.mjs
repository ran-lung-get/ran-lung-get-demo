...
//#region node_modules/.nitro/vite/services/ssr/assets/i18n-DLuw9dTA.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
var LanguageContext = (0, import_react.createContext)(void 0);
var dynamicCacheKey = "ran-lung-get-dynamic-translations";
var dynamicCache = {};
if (typeof window !== "undefined") try {
	const saved = localStorage.getItem(dynamicCacheKey);
	if (saved) dynamicCache = JSON.parse(saved);
} catch (e) {
...
var uiDictionary = {
	...
	"เลือกประสบการณ์การรับประทาน": {
		th: "เลือกประสบการณ์การรับประทาน",
		en: "Choose your dining experience",
		zh: "选择您的用餐体验"
	},
	"เปิดบริการ": {
		th: "เปิดบริการ",
	...
	"ช่องทางการรับอาหาร": {
		th: "ช่องทางการรับอาหาร",
		en: "Dining Option",
		zh: "用餐方式"
	},
	"(กรุณาเลือกช่องทางการรับอาหารด้านบนเพื่อระบุรายละเอียด)": {
		th: "(กรุณาเลือกช่องทางการรับอาหารด้านบนเพื่อระบุรายละเอียด)",
		en: "(Please select dining option above to specify details)",
		zh: "(请在上方选择用餐方式以填写详情)"
	},
	"* กรุณาเลือกช่องทางการรับอาหาร (ทานที่ร้าน, จัดส่งถึงที่ หรือ รับกลับบ้าน) ก่อนเริ่มสั่งซื้อ": {
		th: "* กรุณาเลือกช่องทางการรับอาหาร (ทานที่ร้าน, จัดส่งถึงที่ หรือ รับกลับบ้าน) ก่อนเริ่มสั่งซื้อ",
		en: "* Please select dining channel (dine-in, delivery, or takeaway) before ordering",
		zh: "* 下单前请选择用餐方式（堂食、外送或外带）"
	},
	"ร้านจะจัดเตรียมแพ็กอาหารใส่กล่องให้อย่างดี คุณสามารถมารับอาหารได้ที่เคาน์เตอร์ร้านเมื่อสถานะเปลี่ยนเป็น": {
		...
		en: "The restaurant will package your food nicely. You can pick it up at the counter when the status changes to",
		zh: "餐厅将为您妥善打包食物。当状态变为时，您可以在柜台取餐"
	},
	"พร้อมเสิร์ฟ": {
		th: "พร้อมเสิร์ฟ",
		en: "Ready to Serve",
	...
	"ไม่มีสินค้าในรถเข็น": {
		th: "ไม่มีสินค้าในรถเข็น",
		en: "Your cart is empty",
		zh: "购物车空空如也"
	},
	"เลือกประเภทการสั่ง": {
		th: "เลือกประเภทการสั่ง",
	...
	"โอนเงิน (พร้อมเพย์)": {
		th: "โอนเงิน (พร้อมเพย์)",
		en: "PromptPay Transfer",
		zh: "PromptPay转账"
	},
	"เงินสด": {
		th: "เงินสด",
	...
	"เลือกท็อปปิ้งเพิ่มเติม": {
		th: "เลือกท็อปปิ้งเพิ่มเติม",
		en: "Select Toppings",
		zh: "加配料"
	},
	"เพิ่มลงรถเข็น": {
	...
	"เพิ่มลงในรถเข็นสำเร็จ": {
		th: "เพิ่มลงในรถเข็นสำเร็จ",
		en: "Added to cart successfully",
		zh: "已成功加入购物车"
	},
	"อัปเดตรายการเรียบร้อย": {
		th: "อัปเดตรายการเรียบร้อย",
		en: "Cart updated successfully",
		zh: "购物车已成功更新"
	},
	"ลบรายการเรียบร้อย": {
		th: "ลบรายการเรียบร้อย",
		en: "Item removed from cart",
		zh: "已从购物车删除商品"
	},
	"กรุณากรอกเลขโต๊ะ": {
		th: "กรุณากรอกเลขโต๊ะ",
		en: "Please enter table number",
		zh: "请输入您的桌号"
	},
	...
	"เสร็จสิ้นการเลือก": {
		th: "เสร็จสิ้นการเลือก",
		en: "Done",
		zh: "完成"
	},
	"🔥 ยอดนิยม (แนะนำ)": {
		th: "🔥 ยอดนิยม (แนะนำ)",
		en: "🔥 Popular (Recommend)",
		zh: "🔥 最受欢迎 (推荐)"
	},
	"เมนูขายดีประจำสัปดาห์": {
		th: "เมนูขายดีประจำสัปดาห์",
		en: "Weekly best sellers",
		zh: "本周畅销菜单"
	},
	"💵 ราคา: ต่ำ - สูง": {
		th: "💵 ราคา: ต่ำ - สูง",
	...
	"เมนูราคาประหยัด เรียงตามเงินบาท": {
		th: "เมนูราคาประหยัด เรียงตามเงินบาท",
		en: "Budget menus, sorted by price",
		zh: "经济实惠菜单，按价格排序"
	},
	"💵 ราคา: สูง - ต่ำ": {
		th: "💵 ราคา: สูง - ต่ำ",
	...
	"เมนูระดับพรีเมียมคัดสรรพิเศษ": {
		th: "เมนูระดับพรีเมียมคัดสรรพิเศษ",
		en: "Premium selection menus",
		zh: "特别精选优质菜单"
	},
	"หมด": {
		th: "หมด",
...
var menuDictionary = {
	"กระเพราหมูสับ (ข้าวราด)": {
		...
		zh: {
			name: "泰式罗勒猪肉碎盖饭",
			desc: "猪肉碎与新鲜辣椒和罗勒叶大火翻炒，浇在热腾腾的米饭上"
		}
	},
	"ผัดพริกเผา (ข้าวราด)": {
		th: {
	...
	"น้ำเปล่า": {
		...
		en: {
			name: "Drinking Water",
			desc: "Cold drinking water, small bottle"
		},
		zh: {
			name: "矿泉水",
			desc: "清凉小瓶装饮用水"
	...
	"โค้ก (ขวด)": {
		...
		en: {
			name: "Coke (Bottle)",
			desc: "Carbonated soft drink, Sugar Free or Original based on stock"
		},
		zh: {
			name: "可口可乐（瓶装）",
			desc: "冰镇可乐，根据当前库存提供无糖或普通版"
		}
	},
	"น้ำลำไย": {
		th: {
		...
		en: {
			name: "Longan Juice",
			desc: "Sweet and fragrant traditional longan juice, served cold"
		},
		zh: {
			name: "清甜龙眼水",
			desc: "传统甜美龙眼果汁，冰凉解暑"
	...
	"น้ำส้มคั้น": {
		...
		en: {
			name: "Orange Juice",
			desc: "Freshly squeezed orange juice, sweet and tangy"
		},
		zh: {
			name: "鲜榨橙汁",
			desc: "新鲜橙子榨汁，酸甜可口"
	...
	"เฉาก๊วย": {
		...
		en: {
			name: "Grass Jelly",
			desc: "Refreshing grass jelly in a perfectly sweet syrup, served cold"
		},
		zh: {
			name: "冰镇仙草冻",
			desc: "口感Q弹的黑色仙草，淋上微甜糖浆"
		}
	},
	"น้ำแข็งไส": {
		th: {
		...
		en: {
			name: "Thai Shaved Ice",
			desc: "Traditional shaved ice served with various sweet toppings and syrup"
		},
		zh: {
			name: "泰式刨冰",
			desc: "细碎的冰沙淋上红绿糖浆和炼乳，搭配各种甜料"
		}
	},
	...
	"ผัดคะน้าหมูกรอบ (ข้าวราด)": {
		...
		zh: {
			name: "芥兰炒脆皮猪肉盖饭",
			desc: "爽脆的芥兰与肥美多汁的脆皮五花肉大火翻炒，咸香下饭"
		}
	},
	...
	"กระเทียมพริกไทยหมูชิ้น (ข้าวราด)": {
		...
		zh: {
			name: "蒜香胡椒猪肉片盖饭",
			desc: "滑嫩的猪肉片融入浓郁的蒜香胡椒酱翻炒，洒上金黄蒜末"
		}
	},
	...
	"มาม่าผัดคั่วพริกแกงกุ้ง": {
		...
		zh: {
			name: "红咖喱鲜虾炒方便面",
			desc: "方便面与香辣红咖喱、Q弹鲜虾以及柠檬叶等香草热辣爆炒"
		}
	},
	"ผัดพริกเผาหอยลาย (ข้าวราด)": {
		...
		zh: {
			name: "辣椒膏炒蛤蜊盖饭",
			desc: "鲜活蛤蜊搭配秘制甜辣酱及九层塔快炒，鲜美多汁，配米饭"
		}
	},
	"ผัดผักรวมมิตร (ข้าวราด / มังสวิรัติ)": {
		...
		zh: {
			name: "清炒什锦蔬菜盖饭（素食）",
			desc: "清脆蔬菜快炒，少油低脂，采用素食酱油调味，配米饭"
		}
	},
	"ข้าวต้ม": {
		th: {
			name: "ข้าวต้ม",
			desc: "ข้าวต้มร้อนๆ ปรุงรสกลมกล่อม ทานง่ายสบายท้อง"
		},
		en: {
			name: "Thai Rice Soup",
			desc: "Hot and comforting Thai style rice soup, gently seasoned"
		},
		zh: {
			name: "泰式泡饭",
			desc: "热气腾腾的泰式泡饭，清淡开胃"
	...
	"ข้าวมันไก่": {
		th: {
			name: "ข้าวมันไก่",
			desc: "ข้าวมันไก่ต้มเนื้อนุ่ม เสิร์ฟพร้อมข้าวมันหอมๆ และน้ำจิ้มสูตรเด็ด"
		},
		en: {
			name: "Hainanese Chicken Rice",
			desc: "Tender boiled chicken served with fragrant seasoned rice and savory dipping sauce"
		},
		zh: {
			name: "海南鸡饭",
			desc: "鲜嫩白斩鸡配以香气四溢的鸡油饭和秘制蘸酱"
		}
	},
	"ข้าวซอย": {
		th: {
			name: "ข้าวซอย",
			desc: "ข้าวซอยเส้นนุ่มในน้ำแกงกะหรี่เข้มข้น ท็อปด้วยหมี่กรอบรสชาติเหนือแท้ๆ"
		},
		en: {
			name: "Khao Soi (Northern Curry Noodles)",
			desc: "Soft egg noodles in rich yellow curry broth, topped with crispy noodles"
		},
		zh: {
			name: "泰北金面",
			desc: "浓郁黄咖喱椰奶汤底配以软面条，上覆香脆炸面"
		}
	}
};
var LanguageProvider = ({ children }) => {
	const [language, setLangState] = (0, import_react.useState)("th");
	const [loadingLanguages, setLoadingLanguages] = (0, import_react.useState)({});
	const [localCache, setLocalCache] = (0, import_react.useState)(dynamicCache);
	(0, import_react.useEffect)(() => {
		if (typeof window !== "undefined") {
			const savedLang = localStorage.getItem("ran-lung-get-lang");
			if (savedLang === "th" || savedLang === "en" || savedLang === "zh") setLangState(savedLang);
		}
	}, []);
	const setLanguage = (lang) => {
		setLangState(lang);
		if (typeof window !== "undefined") localStorage.setItem("ran-lung-get-lang", lang);
	};
	const t = (key) => {
	...
	const tMenu = (text, field = "name") => {
		if (language === "th") return text;
		let foundEntry = menuDictionary[text];
		if (!foundEntry && field === "desc") {
			const matchedName = Object.keys(menuDictionary).find((k) => menuDictionary[k].th.desc === text);
			if (matchedName) foundEntry = menuDictionary[matchedName];
		}
		if (foundEntry && foundEntry[language]) return foundEntry[language][field];
		const cacheKey = `${language}:${field}:${text}`;
		if (localCache[cacheKey]) return localCache[cacheKey];
		triggerAsyncTranslation(text, field);
		return text;
	};
	const triggerAsyncTranslation = async (text, field = "ui") => {
		...
		try {
			...
			const res = await translateApi({ data: {
				text,
				sourceLang: "auto",
				targetLang: language
			} });
			if (res && res.translatedText) {
				const updatedCache = {
					...dynamicCache,
					...localCache,
					[cacheKey]: res.translatedText
				};
				dynamicCache = updatedCache;
				setLocalCache(updatedCache);
				if (typeof window !== "undefined") localStorage.setItem(dynamicCacheKey, JSON.stringify(updatedCache));
			}
		} catch (err) {
