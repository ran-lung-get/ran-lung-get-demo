import { Rt as a$1, bt as I, dt as m, f as r, l as e, pt as s$1 } from "./@liff/activity+[...].mjs";
...
function p() {
	var t;
	return "ios" === e() ? (t = r()) && s$1(t, "9.19.0") < 0 ? "https://static.line-scdn.net/liff/edge/2/ios-918-extensions_2_22_0.js" : "https://static.line-scdn.net/liff/edge/2/ios-extensions_2_22_0.js" : "https://static.line-scdn.net/liff/edge/2/non-ios-extensions_2_22_0.js";
}
function y() {
	return a() ? function() {
		return u(this, void 0, void 0, function() {
			return l(this, function(e) {
				switch (e.label) {
					case 0: return [3, 2];
					case 1: return [2, e.sent().default];
					case 2: return [2, new Promise(function(e, o) {
						var r = document.createElement("script"), i = p();
						r.onload = function() {
							var r = window.liffClientExtension;
							r ? e(r) : o(m(I, "Unable to load client features. (Extension is empty)"));
						}, r.onerror = function(e) {
							o(m(I, "Unable to load client features.", { cause: e }));
