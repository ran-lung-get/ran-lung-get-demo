...
function seedMockDatabase() {
  ...
  // 5. Seed Menu Items
  const menu_items = [
    { id: "m_krapao_pork", name: "กระเพราหมูสับ (ข้าวราด)", description: "กระเพราหมูสับผัดกับพริกและกระเทียม เสิร์ฟราดข้าวไทยร้อนๆ", price: 60, image: "/meal/krapao.jpg", image_url: "/meal/krapao.jpg", category: "signature", tags: ["ผัด & กับข้าว", "ยอดนิยม", "เผ็ดจัด", "ตามสั่ง"], is_available: true, is_spicy: true, sort_order: 1, options: [{ id: "spicy", name: "ระดับความเผ็ด", choices: [{ id: "0", label: "ไม่เผ็ด" }, { id: "1", label: "เผ็ดน้อย" }, { id: "2", label: "เผ็ดกลาง" }, { id: "3", label: "เผ็ดมาก" }] }], addons: [{ id: "egg", name: "ไข่ดาว", price: 10 }, { id: "bacon", name: "หมูกรอบ", price: 20 }] },
    { id: "m_pad_nam_prik_pao", name: "ผัดพริกเผา (ข้าวราด)", description: "ผัดเครื่องพริกเผาเข้มข้น เคล้ากับเนื้อหรือไก่ตามสั่ง เสิร์ฟพร้อมข้าว", price: 65, image: "/meal/pad_tua_sea.jpg", image_url: "/meal/pad_tua_sea.jpg", category: "signature", tags: ["ผัด & กับข้าว", "แนะนำ", "รสเข้มข้น"], is_available: true, is_spicy: false, sort_order: 2, options: null, addons: [{ id: "egg", name: "ไข่ดาว", price: 10 }] },
    { id: "m_pad_nam_oil", name: "ผัดน้ำมันหอย (ข้าว/เส้น)", description: "ผัดด้วยน้ำมันหอยหอมหวาน เลือกเนื้อสัตว์และข้าว/เส้นได้ตามต้องการ", price: 65, image: "/meal/khao_moo_garlic.jpg", image_url: "/meal/khao_moo_garlic.jpg", category: "main", tags: ["ผัด & กับข้าว", "เด็กทานได้", "กลมกล่อม"], is_available: true, is_spicy: false, sort_order: 3, options: null, addons: null },
    { id: "m_pad_see_ew", name: "ผัดซีอิ๊ว (เส้นใหญ่)", description: "เส้นใหญ่ผัดซีอิ๊วแบบร้านตามสั่ง ปรุงรสกลมกล่อม เสิร์ฟร้อน", price: 70, image: "/meal/pad_see_ew.jpg", image_url: "/meal/pad_see_ew.jpg", category: "noodles", tags: ["เมนูเส้น", "Signature", "เส้นใหญ่", "หอมกระทะ"], is_available: true, is_spicy: false, sort_order: 4, options: null, addons: null },
    { id: "m_fried_rice", name: "ข้าวผัดกระเทียม (ข้าวผัด)", description: "ข้าวผัดกลิ่นกระเทียม เจียวจนหอม พร้อมผักและเนื้อสัตว์เลือกได้", price: 70, image: "/meal/fried_rice.jpg", image_url: "/meal/fried_rice.jpg", category: "rice", tags: ["ข้าวผัด", "เด็กทานได้", "กระเทียมเจียว", "จานด่วน"], is_available: true, is_spicy: false, sort_order: 5, options: null, addons: null },
    { id: "m_pad_phong_kari", name: "ผัดผงกะหรี่ (ไก่/หมู)", description: "ผัดผงกะหรี่รสกลมกล่อม เสิร์ฟพร้อมข้าวร้อนๆ", price: 75, image: "/meal/pad_pong_gari.jpg", image_url: "/meal/pad_pong_gari.jpg", category: "main", tags: ["ผัด & กับข้าว", "ผงกะหรี่", "ไข่นุ่ม"], is_available: true, is_spicy: false, sort_order: 6, options: null, addons: null },
    { id: "m_pad_pak", name: "ผัดผักรวม (กับข้าว)", description: "ผัดผักสดหลากหลาย ปรุงรสอ่อนๆ ทานคู่กับข้าวสวย", price: 55, image: "/meal/pad_pak.jpg", image_url: "/meal/pad_pak.jpg", category: "vegetarian", tags: ["มังสวิรัติ", "ผัด & กับข้าว", "เพื่อสุขภาพ"], is_available: true, is_spicy: false, sort_order: 7, options: null, addons: null },
    { id: "m_pad_prik_gaeng", name: "ผัดพริกแกง (ตามสั่ง)", description: "ผัดพริกแกงกลมกล่อม สามารถเลือกเป็นหมู ไก่ หรือทะเลได้", price: 80, image: "/meal/pad_tua_sea.jpg", image_url: "/meal/pad_tua_sea.jpg", category: "signature", tags: ["ผัด & กับข้าว", "เผ็ดจัด", "พริกแกง", "แนะนำ"], is_available: true, is_spicy: true, sort_order: 8, options: null, addons: null },
    { id: "d_water", name: "น้ำเปล่า", description: "น้ำดื่มเย็นๆ ขวดเล็ก", price: 15, image: "/meal/water.jpg", image_url: "/meal/water.jpg", category: "drinks", tags: ["เครื่องดื่ม", "สดชื่น"], is_available: true, is_spicy: false, sort_order: 9, options: null, addons: null },
    { id: "d_coke", name: "โค้ก (ขวด)", description: "น้ำอัดลม ซีโร่/ปกติ ตามสต็อก", price: 35, image: "/meal/coke.jpg", image_url: "/meal/coke.jpg", category: "drinks", tags: ["เครื่องดื่ม", "น้ำอัดลม", "เย็นซ่า"], is_available: true, is_spicy: false, sort_order: 10, options: null, addons: null },
    { id: "d_luangyai", name: "น้ำลำไย", description: "น้ำลำไยหวานหอม เสิร์ฟเย็น", price: 45, image: "/meal/longan_juice.jpg", image_url: "/meal/longan_juice.jpg", category: "drinks", tags: ["เครื่องดื่ม", "Signature", "หวานชื่นใจ", "แนะนำ"], is_available: true, is_spicy: false, sort_order: 11, options: null, addons: null },
    { id: "d_orange", name: "น้ำส้มคั้น", description: "น้ำส้มคั้นสด หวานอมเปรี้ยว", price: 50, image: "/meal/orange_juice.jpg", image_url: "/meal/orange_juice.jpg", category: "drinks", tags: ["เครื่องดื่ม", "วิตามินซี", "สดชื่น"], is_available: true, is_spicy: false, sort_order: 12, options: null, addons: null },
    { id: "dess_grass_jelly", name: "เฉาก๊วย", description: "เฉาก๊วยเย็นหวานกำลังดี ท็อปด้วยน้ำเชื่อม", price: 40, image: "/meal/grass_jelly.webp", image_url: "/meal/grass_jelly.webp", category: "dessert", tags: ["ของหวาน", "ดับร้อน", "เย็นสดชื่น"], is_available: true, is_spicy: false, sort_order: 13, options: null, addons: null },
    { id: "dess_shaved_ice", name: "น้ำแข็งไส", description: "น้ำแข็งไสพร้อมท็อปปิ้งหลากหลาย", price: 55, image: "/meal/shaved_ice.jpg", image_url: "/meal/shaved_ice.jpg", category: "dessert", tags: ["ของหวาน", "Signature", "ท็อปปิ้งแน่น", "แนะนำ"], is_available: true, is_spicy: false, sort_order: 14, options: null, addons: null },
    { id: "m_krapao_crispy_pork", name: "กระเพราหมูกรอบ (ข้าวราด)", description: "กระเพราหมูกรอบหนังสามชั้นกรอบนอกนุ่มใน ผัดใบกระเพราแท้รสจัดจ้าน เสิร์ฟราดข้าวหอมมะลิร้อนๆ", price: 70, image: "/meal/krapao.jpg", image_url: "/meal/krapao.jpg", category: "signature", tags: ["ผัด & กับข้าว", "หมูกรอบ", "ยอดนิยม", "เผ็ดจัด"], is_available: true, is_spicy: true, sort_order: 15, options: null, addons: [{ id: "egg", name: "ไข่ดาว", price: 10 }] },
    { id: "m_kana_crispy_pork", name: "ผัดคะน้าหมูกรอบ (ข้าวราด)", description: "ผัดคะน้าใบเขียวสดกรอบกับหมูกรอบสามชั้น ปรุงรสกลมกล่อม ราดข้าวหอมมะลิร้อนๆ", price: 70, image: "/meal/pad_pak.jpg", image_url: "/meal/pad_pak.jpg", category: "main", tags: ["ผัด & กับข้าว", "Signature", "หมูกรอบ", "คะน้ากรอบ", "ยอดนิยม"], is_available: true, is_spicy: false, sort_order: 16, options: null, addons: [{ id: "egg", name: "ไข่ดาว", price: 10 }] },
    { id: "m_prik_gaeng_crispy_pork", name: "ผัดพริกแกงหมูกรอบ (ข้าวราด)", description: "พริกแกงรสเข้มข้นผัดคลุกเคล้ากับหมูกรอบและถั่วฝักยาว ราดข้าวหอมมะลิร้อนๆ", price: 70, image: "/meal/pad_tua_sea.jpg", image_url: "/meal/pad_tua_sea.jpg", category: "main", tags: ["ผัด & กับข้าว", "หมูกรอบ", "เผ็ดจัด", "พริกแกง"], is_available: true, is_spicy: true, sort_order: 17, options: null, addons: [{ id: "egg", name: "ไข่ดาว", price: 10 }] },
    { id: "m_garlic_sliced_pork", name: "กระเทียมพริกไทยหมูชิ้น (ข้าวราด)", description: "หมูชิ้นนุ่มๆ ผัดซอสกระเทียมพริกไทยรสเข้มข้น หอมกระเทียมเจียว ราดข้าว", price: 60, image: "/meal/khao_moo_garlic.jpg", image_url: "/meal/khao_moo_garlic.jpg", category: "main", tags: ["ผัด & กับข้าว", "กระเทียมเจียว", "หมูนุ่ม", "เด็กทานได้"], is_available: true, is_spicy: false, sort_order: 18, options: null, addons: [{ id: "egg", name: "ไข่ดาว", price: 10 }] },
    { id: "m_pong_kari_sea", name: "ผัดผงกะหรี่ทะเล (ข้าวราด)", description: "เนื้อกุ้งและปลาหมึกสดผัดผงกะหรี่เข้มข้น ไข่นุ่มละมุนลิ้น ราดข้าวหอมมะลิ", price: 70, image: "/meal/pad_pong_gari.jpg", image_url: "/meal/pad_pong_gari.jpg", category: "signature", tags: ["ผัด & กับข้าว", "ซีฟู้ด", "ผงกะหรี่", "แนะนำ"], is_available: true, is_spicy: false, sort_order: 19, options: null, addons: [{ id: "egg", name: "ไข่ดาว", price: 10 }] },
    { id: "m_khua_prik_beef", name: "คั่วพริกแกงเนื้อ (ข้าวราด)", description: "เนื้อวัวเกรดดีผัดคั่วพริกแกงตำมือ รสจัดจ้านถึงใจ สมุนไพรไทยครบเครื่อง ราดข้าว", price: 60, image: "/meal/pad_tua_sea.jpg", image_url: "/meal/pad_tua_sea.jpg", category: "main", tags: ["ผัด & กับข้าว", "เนื้อวัว", "เผ็ดจัด", "สมุนไพร"], is_available: true, is_spicy: true, sort_order: 20, options: null, addons: [{ id: "egg", name: "ไข่ดาว", price: 10 }] },
    { id: "m_see_ew_crispy_pork", name: "ผัดซีอิ๊วเส้นใหญ่หมูกรอบ", description: "เส้นใหญ่เหนียวนุ่มผัดซีอิ๊วดำหอมกลิ่นกระทะ คลุกเคล้ากับหมูกรอบและคะน้าสด", price: 75, image: "/meal/pad_see_ew.jpg", image_url: "/meal/pad_see_ew.jpg", category: "noodles", tags: ["เมนูเส้น", "Signature", "หมูกรอบ", "หอมกระทะ"], is_available: true, is_spicy: false, sort_order: 21, options: null, addons: null },
    { id: "m_mama_prik_gaeng_shrimp", name: "มาม่าผัดคั่วพริกแกงกุ้ง", description: "เส้นมาม่าเหนียวนุ่มผัดซอสพริกแกงเข้มข้นและกุ้งสดเด้งๆ สมุนไพรหอมกรุ่น", price: 65, image: "/meal/pad_tua_sea.jpg", image_url: "/meal/pad_tua_sea.jpg", category: "noodles", tags: ["เมนูเส้น", "Signature", "ซีฟู้ด", "กุ้งสด", "เผ็ดจัด"], is_available: true, is_spicy: true, sort_order: 22, options: null, addons: null },
    { id: "m_prik_pao_clam", name: "ผัดพริกเผาหอยลาย (ข้าวราด)", description: "หอยลายสดผัดน้ำพริกเผาสูตรเด็ด รสชาติหวานเค็มเผ็ดลงตัว หอมใบโหระพา ราดข้าว", price: 60, image: "/meal/pad_tua_sea.jpg", image_url: "/meal/pad_tua_sea.jpg", category: "main", tags: ["ผัด & กับข้าว", "ซีฟู้ด", "หอยลาย", "แนะนำ"], is_available: true, is_spicy: false, sort_order: 23, options: null, addons: [{ id: "egg", name: "ไข่ดาว", price: 10 }] },
    { id: "m_pad_pak_no_meat", name: "ผัดผักรวมมิตร (ข้าวราด / มังสวิรัติ)", description: "ผัดผักสดรวมมิตรรสชาติเบาๆ สุขภาพดี ปรุงด้วยซีอิ๊วขาวและน้ำมันหอยสูตรเจ ราดข้าว", price: 50, image: "/meal/pad_pak.jpg", image_url: "/meal/pad_pak.jpg", category: "vegetarian", tags: ["มังสวิรัติ", "ผัด & กับข้าว", "เพื่อสุขภาพ", "เจ"], is_available: true, is_spicy: false, sort_order: 24, options: null, addons: null },
  ];
