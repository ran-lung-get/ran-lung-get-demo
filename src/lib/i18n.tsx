...
const uiDictionary: Record<string, Record<Language, string>> = {
  ...
  "ภาษา / Language": { th: "ภาษา / Language", en: "Language", zh: "语言" },
  "เปลี่ยนภาษา": { th: "เปลี่ยนภาษา", en: "Change Language", zh: "切换语言" },
  ...
  "ยกเลิกและคืนเงิน": { th: "ยกเลิกและคืนเงิน", en: "Cancel & Refund", zh: "取消并退款" },
  "ยกเลิก / ขอคืนเงิน": { th: "ยกเลิก / ขอคืนเงิน", en: "Cancelled / Refund", zh: "已取消 / 退款" },
  "ติดต่อร้านลุงเกตุ (ด่วน)": { th: "ติดต่อ DineOS (ด่วน)", en: "Call DineOS (Urgent)", zh: "致电 DineOS（紧急）" },
  "ติดต่อ DineOS (ด่วน)": { th: "ติดต่อ DineOS (ด่วน)", en: "Call DineOS (Urgent)", zh: "致电 DineOS（紧急）" },
  ...
  "ตู้คำอธิษฐาน (Gacha)": {
    ...
    en: "DineOS Wish (Gacha)",
    zh: "DineOS 祈愿 (扭蛋)",
  },
  "ตู้คำอธิษฐาน DineOS": {
    th: "ตู้คำอธิษฐาน DineOS",
    en: "DineOS Celestial Wish",
    zh: "DineOS 星空祈愿",
  },
  "ตู้คำอธิษฐานลุงเก็ต": {
    th: "ตู้คำอธิษฐาน DineOS",
  ...
  "ตู้คำอธิษฐาน & สมุดสะสมการ์ด DineOS": {
    th: "ตู้คำอธิษฐาน & สมุดสะสมการ์ด DineOS",
    en: "DineOS Wish & Card Album",
    zh: "DineOS 星空祈愿与卡牌图鉴",
  },
  ...
  "ตู้คำอธิษฐาน & สะสมการ์ด DineOS": {
    th: "ตู้คำอธิษฐาน & สะสมการ์ด DineOS",
    en: "DineOS Wish & Card Collection",
    zh: "DineOS 祈愿与美食卡牌收集",
  },
  ...
  "ตู้คำอธิษฐาน & มินิเกม DineOS": {
    th: "ตู้คำอธิษฐาน & มินิเกม DineOS",
    en: "Wish & DineOS Mini Games",
    zh: "祈愿阁与 DineOS 小游戏",
  },
  ...
  "ตู้คำอธิษฐาน, สมุดสะสมการ์ด & 3 มินิเกม DineOS": {
    th: "ตู้คำอธิษฐาน, สมุดสะสมการ์ด & 3 มินิเกม DineOS",
    en: "Wish, Card Album & 3 DineOS Mini Games",
    zh: "祈愿阁、卡牌图鉴与3款 DineOS 小游戏",
  },
  ...
  "สุ่มสะสมการ์ด DineOS เทพกระทะเหล็ก, หมูกรอบเพลิงสวรรค์, และราชากะเพรา": {
    th: "สุ่มสะสมการ์ด DineOS เทพกระทะเหล็ก, หมูกรอบเพลิงสวรรค์, และราชากะเพรา",
    en: "Collect DineOS God Chef, Heavenly Crispy Pork, and King of Krapao cards",
    zh: "抽取收集 DineOS 铁锅食神、九重天脆皮烧肉与打抛之王卡牌",
  },
  ...
  "แลกคูปองเป็นตั๋วสุ่ม": {
    th: "แลกคูปองเป็นตั๋วสุ่ม",
    en: "Recycle for Tickets",
    zh: "将卡券兑换为祈愿券",
  },
  "แลกตั๋ว 🎫": {
    th: "แลกตั๋ว 🎫",
  ...
  "แลกทั้งหมดเป็นตั๋ว": {
    th: "แลกทั้งหมดเป็นตั๋ว",
    en: "Recycle All to Tickets",
    zh: "全部兑换为祈愿券",
  },
  "ล้างทั้งหมด": {
    th: "ล้างทั้งหมด",
  ...
  "ยืนยันการลบคูปองทั้งหมด": {
    th: "ยืนยันการลบคูปองทั้งหมด",
    en: "Confirm Clear All Coupons",
    zh: "确认清空所有卡券",
  },
  "คุณต้องการลบคูปองทั้งหมดในกระเป๋าใช่หรือไม่?": {
    th: "คุณต้องการลบคูปองทั้งหมดในกระเป๋าใช่หรือไม่?",
    en: "Are you sure you want to delete all coupons in your wallet?",
    zh: "您确定要清空卡券包中的所有卡券吗？",
  },
  "แลกคูปองสำเร็จ!": {
    th: "แลกคูปองสำเร็จ!",
    en: "Recycled successfully!",
    zh: "兑换成功！",
  },
  "ลบคูปองสำเร็จ": {
    th: "ลบคูปองสำเร็จ",
  ...
  "ล้างคูปองทั้งหมดแล้ว": {
    th: "ล้างคูปองทั้งหมดแล้ว",
    en: "All coupons cleared",
    zh: "已清空所有卡券",
  },
  "จัดกลุ่มคูปองซ้ำ": {
    th: "จัดกลุ่มคูปองซ้ำ",
  ...
  "นำตั๋วไปสุ่มลุ้นรับส่วนลด 50% และสะสมการ์ด DineOS": {
    th: "นำตั๋วไปสุ่มลุ้นรับส่วนลด 50% และสะสมการ์ด DineOS",
    en: "Use tickets to win 50% off & collect DineOS legendary cards",
    zh: "使用祈愿券抽取五折卡券与收集 DineOS 卡牌",
  },
  ...
  "ร้านอาหารตามสั่ง DineOS": {
    th: "ร้านอาหารตามสั่ง DineOS",
    en: "DineOS Restaurant",
    zh: "DineOS 餐厅",
  },
  ...
  "ระบบรับออเดอร์ส่งตรงถึงครัวร้านลุงเกตุทันที": {
    th: "ระบบรับออเดอร์ส่งตรงถึงครัว DineOS ทันที",
    en: "Orders are sent directly to DineOS kitchen instantly",
    zh: "订单实时直达 DineOS 厨房",
  },
  "ระบบรับออเดอร์ส่งตรงถึงครัว DineOS ทันที": {
    th: "ระบบรับออเดอร์ส่งตรงถึงครัว DineOS ทันที",
    en: "Orders are sent directly to DineOS kitchen instantly",
    zh: "订单实时直达 DineOS 厨房",
  },
  ...
  "กล่องสุ่มอาหาร DineOS": {
    th: "กล่องสุ่มอาหาร DineOS",
    en: "DineOS Mystery Meal Box",
    zh: "DineOS 美食盲盒",
  },
  ...
  // Mini-Games Arcade
  "ศูนย์มินิเกม DineOS": { th: "ศูนย์มินิเกม DineOS", en: "DineOS Arcade", zh: "DineOS 街机小游戏" },
  "ศูนย์มินิเกมลุงเกตุ": { th: "ศูนย์มินิเกม DineOS", en: "DineOS Arcade", zh: "DineOS 街机小游戏" },
  "ศูนย์มินิเกม DineOS (Mini Games)": { th: "ศูนย์มินิเกม DineOS (Mini Games)", en: "DineOS Mini-Games", zh: "DineOS 小游戏中心" },
  "ศูนย์มินิเกมลุงเกตุ (Mini Games)": { th: "ศูนย์มินิเกม DineOS (Mini Games)", en: "DineOS Mini-Games", zh: "DineOS 小游戏中心" },
  "ศูนย์มินิเกม DineOS (Mini-Games)": { th: "ศูนย์มินิเกม DineOS (Mini-Games)", en: "DineOS Mini-Games", zh: "DineOS 小游戏中心" },
  "ศูนย์มินิเกมลุงเกตุ (Mini-Games)": { th: "ศูนย์มินิเกม DineOS (Mini-Games)", en: "DineOS Mini-Games", zh: "DineOS 小游戏中心" },
  ...
  "ลุ้นรับคูปองส่วนลด 50%, การ์ดระดับตำนาน UR และเล่นเกมศึก 8-Bit Dragon Quest, DineOS ควงกระทะ & วงล้อเสี่ยงทายดวงชะตา": {
    th: "ลุ้นรับคูปองส่วนลด 50%, การ์ดระดับตำนาน UR และเล่นเกมศึก 8-Bit Dragon Quest, DineOS ควงกระทะ & ดวล 8-Bit ยิงโจร",
    en: "Win 50% discount coupons, UR cards, and enjoy 8-Bit Dragon Quest, DineOS Wok Master & 8-Bit Bandit Shootout!",
    zh: "赢取五折优惠券、UR传说神卡，畅玩8位勇者斗恶龙、DineOS大厨翻锅与8位像素神枪手捉强盗！",
  },
  ...
  "โจรบุกปล้นร้าน DineOS! เล็งยิงโจรให้ไว อย่าให้โดนตัวประกัน!": { th: "โจรบุกปล้นร้าน DineOS! เล็งยิงโจรให้ไว อย่าให้โดนตัวประกัน!", en: "Bandits are raiding DineOS restaurant! Shoot fast and rescue hostages!", zh: "强盗闯入 DineOS 餐厅！迅速瞄准射击，千万别伤到人质！" },
  "โจรบุกปล้นร้านลุงเกตุ! เล็งยิงโจรให้ไว อย่าให้โดนตัวประกัน!": { th: "โจรบุกปล้นร้าน DineOS! เล็งยิงโจรให้ไว อย่าให้โดนตัวประกัน!", en: "Bandits are raiding DineOS restaurant! Shoot fast and rescue hostages!", zh: "强盗闯入 DineOS 餐厅！迅速瞄准射击，千万别伤到人质！" },
  ...
  "DRAGON QUEST: DINEOS 8-BIT BATTLE": { th: "DRAGON QUEST: DINEOS 8-BIT BATTLE", en: "DRAGON QUEST: DINEOS 8-BIT BATTLE", zh: "勇者斗恶龙：DineOS 8位像素大乱斗" },
  "DRAGON QUEST: ลุงเกตุ 8-BIT BATTLE": { th: "DRAGON QUEST: DINEOS 8-BIT BATTLE", en: "DRAGON QUEST: DINEOS 8-BIT BATTLE", zh: "勇者斗恶龙：DineOS 8位像素大乱斗" },
  "ผู้กล้า DineOS ชักตะหลิวเหล็กกล้าก้าวเข้าสู่สนามรบ!": { th: "ผู้กล้า DineOS ชักตะหลิวเหล็กกล้าก้าวเข้าสู่สนามรบ!", en: "Hero DineOS draws his iron spatula and enters battle!", zh: "勇者 DineOS 拔出铁铲踏入战场！" },
  "ผู้กล้าลุงเกตุ ชักตะหลิวเหล็กกล้าก้าวเข้าสู่สนามรบ!": { th: "ผู้กล้า DineOS ชักตะหลิวเหล็กกล้าก้าวเข้าสู่สนามรบ!", en: "Hero DineOS draws his iron spatula and enters battle!", zh: "勇者 DineOS 拔出铁铲踏入战场！" },
  ...
  "DineOS หมดสติลง กลับไปฝึกวิชาผัดกระทะแล้วมาสู้ใหม่!": { th: "DineOS หมดสติลง กลับไปฝึกวิชาผัดกระทะแล้วมาสู้ใหม่!", en: "DineOS fainted! Train your wok skills and challenge again!", zh: "DineOS 体力不支倒下！回厨房磨练厨艺再来挑战！" },
  "ลุงเกตุหมดสติลง กลับไปฝึกวิชาผัดกระทะแล้วมาสู้ใหม่!": { th: "DineOS หมดสติลง กลับไปฝึกวิชาผัดกระทะแล้วมาสู้ใหม่!", en: "DineOS fainted! Train your wok skills and challenge again!", zh: "DineOS 体力不支倒下！回厨房磨练厨艺再来挑战！" },
  "ด่านที่ผ่าน": { th: "ด่านที่ผ่าน", en: "Cleared Stages", zh: "通关关卡" },
  "DineOS": { th: "DineOS", en: "DineOS", zh: "DineOS" },
  "ลุงเกตุ": { th: "DineOS", en: "DineOS", zh: "DineOS" },
  "สวมบทบาทเป็น ": { th: "สวมบทบาทเป็น ", en: "Play as ", zh: "化身为 " },
  "ผู้กล้า DineOS": { th: "ผู้กล้า DineOS", en: "Hero DineOS", zh: "勇者 DineOS" },
  "ผู้กล้าลุงเกตุ": { th: "ผู้กล้า DineOS", en: "Hero DineOS", zh: "勇者 DineOS" },
  ...
  "DineOS ควงกระทะ": { th: "DineOS ควงกระทะ", en: "DineOS Wok Master", zh: "DineOS 大厨翻锅" },
  "ลุงเกตุควงกระทะ": { th: "DineOS ควงกระทะ", en: "DineOS Wok Master", zh: "DineOS 大厨翻锅" },
  ...
  "เกม DineOS ควงกระทะ": { th: "เกม DineOS ควงกระทะ", en: "DineOS Wok Master", zh: "DineOS 大厨翻锅游戏" },
  "เกมลุงเกตุควงกระทะ": { th: "เกม DineOS ควงกระทะ", en: "DineOS Wok Master", zh: "DineOS 大厨翻锅游戏" },
  ...
  "ฝีมือระดับปรมาจารย์แห่ง DineOS!": { th: "ฝีมือระดับปรมาจารย์แห่ง DineOS!", en: "Master chef skills approved by DineOS!", zh: "DineOS 亲传宗师级厨艺！" },
  "ฝีมือระดับปรมาจารย์แห่งร้านลุงเกตุ!": { th: "ฝีมือระดับปรมาจารย์แห่ง DineOS!", en: "Master chef skills approved by DineOS!", zh: "DineOS 亲传宗师级厨艺！" },
  "สมุดสะสมการ์ด DineOS": { th: "สมุดสะสมการ์ด DineOS", en: "DineOS Card Album", zh: "DineOS 卡牌图鉴" },
  "สมุดสะสมการ์ดลุงเกตุ": { th: "สมุดสะสมการ์ด DineOS", en: "DineOS Card Album", zh: "DineOS 卡牌图鉴" },
