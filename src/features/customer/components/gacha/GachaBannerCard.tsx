...
export function GachaBannerCard({
  ...
  const bannerDetails = isCardBanner
    ? {
        ...
        subtitle: t("สุ่มสะสมการ์ด DineOS เทพกระทะเหล็ก, หมูกรอบเพลิงสวรรค์, และราชากะเพรา"),
        bannerBg: "from-purple-950 via-slate-900 to-indigo-950",
        borderColor: "border-purple-500/40",
        accentGlow: "rgba(168,85,247,0.3)",
        featuredItems: [
          { name: language === "th" ? "DineOS เทพกระทะเหล็ก" : language === "zh" ? "DineOS 铁锅食神" : "DineOS God Chef", rarity: "UR 6★", img: "/logoHome.png" },
