...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "DineOS" },
      { name: "description", content: "ระบบสั่งอาหารและบริหารจัดการร้านอาหาร DineOS" },
      { name: "author", content: "DineOS" },
      { property: "og:title", content: "DineOS" },
      { property: "og:description", content: "ระบบสั่งอาหารและบริหารจัดการร้านอาหาร DineOS" },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:title", content: "DineOS" },
      { name: "twitter:description", content: "ระบบสั่งอาหารและบริหารจัดการร้านอาหาร DineOS" },
    ],
    links: [
